...
server <- function(input, output, session) {
  ...
  observeEvent(input$tabs, {
    ...
    if(input$tabs == "predict_from_text"){
      ...
      #Load the tokenizer
      tokenizer_fermentation=reticulate::py_load_object(filename="tokenizer/tokenizer_fermentation.pkl", pickle = "pickle")
      
      #Load the model
      model_fermentation <- keras::load_model_tf("models/model_fermentation")
      ...
      #Load the tokenizer
      tokenizer_methanogenesis=reticulate::py_load_object(filename="tokenizer/tokenizer_methanogenesis.pkl", pickle = "pickle")
      
      #Load the model
      model_methanogenesis <- keras::load_model_tf("models/model_methanogenesis")
    ...
    if(input$tabs == "neural_nets_tutorial"){
      #Instead of loading keras, call functions via keras::
      #Load the tokenizer
      tokenizer=reticulate::py_load_object(filename="tokenizer/tokenizer_tutorial.pkl", pickle = "pickle")
      
      # Load the model
      model <- keras::load_model_tf("models/model_tutorial")
